export const templateStyles = {
  modern: {
    ...
    sectionHeader: "text-lg font-bold text-gray-700 mb-1 mt-3 flex items-center after:content-[''] after:grow after:h-px after:bg-gray-200 after:ml-2",
    skills: 'flex flex-wrap gap-1',
    skillItem: 'bg-blue-50 text-blue-700 px-2 py-0.5 rounded-full text-xs font-medium shadow-xs',
  ...
  classic: {
    container: 'bg-gray-50 rounded-lg border border-gray-300 p-8 max-w-4xl mx-auto',
    ...
    sectionHeader: 'font-serif text-lg font-bold text-black mb-1 mt-3 uppercase border-b border-gray-400',
  ...
  minimal: {
    container: 'bg-white p-8 rounded-lg border-t-4 border-blue-500 max-w-4xl mx-auto shadow-xs',
    nameContainer: 'mb-2',
    name: 'text-3xl font-bold text-gray-900',
    title: 'text-base text-gray-400 font-medium',
    sectionHeader: 'text-lg font-bold text-gray-800 mb-1 mt-3 border-b border-gray-200',
    skills: 'flex flex-wrap gap-1',
  ...
  creative: {
    container: 'bg-linear-to-br from-purple-50 to-blue-50 p-8 rounded-lg max-w-4xl mx-auto shadow-md',
    nameContainer: 'text-center pb-1 mb-2',
    name: 'text-3xl font-bold bg-linear-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent',
    title: 'text-base text-gray-500 font-medium',
    sectionHeader: 'text-lg font-bold mb-1 mt-3 bg-linear-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent inline-block',
    skills: 'flex flex-wrap gap-1',
    skillItem: 'bg-white bg-opacity-50 backdrop-filter backdrop-blur-xs px-2 py-0.5 rounded-full text-xs border border-purple-200 text-purple-700',
    text: 'text-gray-600 text-sm',
  ...
  professional: {
    container: 'bg-white p-8 border-l-8 rounded-lg border-gray-700 max-w-4xl mx-auto shadow-md',
    ...
    sectionHeader: 'text-lg font-bold text-gray-800 mb-1 mt-3 uppercase border-b border-gray-300',
    skills: 'grid grid-cols-3 gap-1 sm:grid-cols-4',
    skillItem: 'bg-gray-100 text-gray-800 px-2 py-0.5 text-center text-xs border-l-2 border-gray-700',
    text: 'text-gray-700 leading-tight text-sm',
    projectTitle: 'text-base font-bold text-gray-800',
    projectTech: 'text-xs font-medium text-gray-600 border-l-2 border-gray-400 pl-2',
    expTitle: 'text-base font-bold text-gray-800',
    expDetails: 'text-xs font-medium text-gray-600 border-l-2 border-gray-400 pl-2',
    eduTitle: 'text-base font-bold text-gray-800',
    contactList: 'grid grid-cols-2 gap-1 text-gray-700 text-sm',
  },

  elegant: {
    container: 'bg-linear-to-br from-slate-50 to-gray-100 rounded-lg p-8 max-w-4xl mx-auto shadow-lg border border-gray-200',
    ...
    sectionHeader: "text-xl font-light text-indigo-700 mb-1 mt-3 tracking-wide relative before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-8 before:h-0.5 before:bg-indigo-300",
    skills: 'flex flex-wrap gap-2',
    skillItem: 'bg-indigo-100 text-indigo-700 px-3 py-1 rounded-md text-sm font-light border border-indigo-200',
  ...
  executive: {
    container: 'bg-white p-8 max-w-4xl mx-auto rounded-lg shadow-xl border-t-4 border-gray-800',
    ...
    sectionHeader: 'text-lg font-bold text-gray-800 mb-1 mt-3 uppercase tracking-wider bg-gray-100 px-2 py-1',
    skills: 'grid grid-cols-4 gap-1 sm:grid-cols-5',
    skillItem: 'bg-gray-800 text-white px-2 py-1 text-center text-xs font-medium',
    text: 'text-gray-700 text-sm leading-relaxed',
    projectTitle: 'text-base font-bold text-gray-800',
    projectTech: 'text-xs font-medium text-gray-600 bg-gray-100 px-2 py-0.5 inline-block',
    expTitle: 'text-base font-bold text-gray-800',
    expDetails: 'text-xs font-medium text-gray-600 bg-gray-100 px-2 py-0.5',
    eduTitle: 'text-base font-bold text-gray-800',
    contactList: 'bg-gray-800 text-white p-2 -mx-8 -mb-8 grid grid-cols-2 gap-2 text-sm',
  },

  techie: {
    container: 'bg-gray-900 text-green-400 p-8 rounded-lg max-w-4xl mx-auto shadow-lg border border-green-500 font-mono',
    ...
    sectionHeader: "text-lg font-bold text-green-300 mb-1 mt-3 uppercase tracking-wider relative before:content-['>>'] before:text-green-500 before:mr-2",
    skills: 'flex flex-wrap gap-1',
    skillItem: 'bg-green-900 text-green-300 px-2 py-0.5 text-xs border border-green-500',
  ...
  artistic: {
    container: 'bg-linear-to-br from-pink-50 via-purple-50 to-indigo-50 rounded-lg p-8 max-w-4xl mx-auto shadow-lg border-2 border-purple-200',
    ...
    sectionHeader: "text-xl font-bold mb-1 mt-3 bg-linear-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-linear-to-r after:from-pink-300 after:to-purple-300",
    skills: 'flex flex-wrap gap-2',
    skillItem: 'bg-linear-to-r from-pink-100 to-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm font-medium border border-purple-200 shadow-xs',
    text: 'text-gray-700 text-sm leading-relaxed',
    projectTitle: 'text-lg font-bold bg-linear-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent',
    projectTech: 'text-xs text-purple-500 font-medium',
    expTitle: 'text-lg font-bold bg-linear-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent',
    expDetails: 'text-sm text-purple-500 font-medium',
    eduTitle: 'text-lg font-bold bg-linear-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent',
    contactList: 'grid grid-cols-2 gap-2 text-purple-700 text-sm',
  },

  corporate: {
    container: 'bg-white p-8 max-w-4xl mx-auto rounded-lg shadow-md border-2 border-blue-900',
    ...
    sectionHeader: 'text-lg font-bold text-blue-900 mb-1 mt-3 uppercase bg-blue-100 px-3 py-1 border-l-4 border-blue-900',
    skills: 'grid grid-cols-3 gap-2 sm:grid-cols-4',
    skillItem: 'bg-blue-900 text-white px-2 py-1 text-center text-xs font-semibold uppercase tracking-wide',
    text: 'text-gray-700 text-sm leading-relaxed',
    ...
    contactList: 'bg-blue-900 text-white p-2 -mx-8 -mb-8 grid grid-cols-2 gap-2 text-sm',
  },
};
