            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        Watch our advanced GenAI system with RAG pipeline analyze resumes against job descriptions in real-time.
                        <span className="text-foreground font-medium">
                            {' '}
                            Get instant ATS scores, semantic matching, and AI-powered optimization suggestions.
                        </span>
                    </p>
