...
export function ATSResults({ analysis, className }: ATSResultsProps) {
    ...
    return (
        <Card className={cn("backdrop-blur-sm bg-white/70 dark:bg-slate-900/70 border-slate-200/60 dark:border-slate-700/60", className)}>
            <CardHeader>
                    ...
                    <TabsContent value="overview" className="space-y-6">
                        ...
                        >
                            <div className="relative inline-flex items-center justify-center w-32 h-32 mb-4">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <span className={cn("text-3xl font-bold", getScoreColor(analysis.scores.overall))}>
                            ...
                            <div className="flex items-center justify-center gap-2 mb-2">
                                ...
                                <span className={cn("font-semibold", getScoreColor(analysis.scores.overall))}>
                                    {getScoreLabel(analysis.scores.overall)}
                                </span>
                            </div>
                            <p className="text-sm text-muted-foreground">
                                Your resume has a {getScoreLabel(analysis.scores.overall).toLowerCase()} ATS compatibility rating
                            </p>
                        </motion.div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                {[
                                    { label: 'Keyword Match', value: analysis.scores.keyword, icon: CheckCircle },
                                    { label: 'Format Quality', value: analysis.scores.format, icon: BarChart3 },
                                    { label: 'Content Relevance', value: analysis.scores.content, icon: Brain },
                                    { label: 'Semantic Similarity', value: analysis.scores.semantic, icon: TrendingUp },
                                ].map((item, index) => (
                                    <motion.div
                                        key={item.label}
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3 min-w-[120px]">
                                            <Progress
                                                ...
                                                className="w-16 h-2"
                                            />
                                            <span className={cn("text-sm font-semibold w-8", getScoreColor(item.value))}>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {analysis.matchedKeywords.length > 15 && (
                                    <Badge variant="outline">+{analysis.matchedKeywords.length - 15} more</Badge>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {analysis.missingKeywords.length > 15 && (
                                    <Badge variant="outline">+{analysis.missingKeywords.length - 15} more</Badge>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-semibold">{analysis.industryFit}%</span>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-semibold">{analysis.readabilityScore}%</span>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                ...
                                <div className="flex items-center gap-2">
                                    <Progress value={analysis.semanticSimilarity} className="flex-1" />
                                    <span className="text-sm font-semibold">{analysis.semanticSimilarity}%</span>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                ...
                                <div className="flex items-center gap-2">
                                    <Progress value={analysis.keywordDensity * 10} className="flex-1" />
                                    <span className="text-sm font-semibold">{analysis.keywordDensity}%</span>
                                </div>
                            </div>
                        </div>
                    </TabsContent>
