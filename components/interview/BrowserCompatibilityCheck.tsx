      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-background via-background to-blue-50/50 dark:to-blue-950/20 p-4">
        <Card className="w-full max-w-2xl border-red-200 dark:border-red-900">
          <CardHeader>
            ...
            <CardDescription>
              Your current setup may not support all features of the AI
              Interview Practice.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                ...
                <span
                  className={
                    browserInfo.hasWebSpeech ? "text-green-600" : "text-red-600"
                  }
                >
              ...
              <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                ...
                <span
                  className={
                    browserInfo.isMobile ? "text-yellow-600" : "text-green-600"
                  }
                >
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1 ml-4 list-disc">
                    <li>
                      Use <strong>Google Chrome</strong>,{" "}
                      <strong>Microsoft Edge</strong>, or{" "}
                      <strong>Safari</strong>
                    </li>
                    <li>
                      Use a <strong>desktop or laptop</strong> computer
                    </li>
                    <li>
                      Connect a <strong>working microphone</strong>
                    </li>
                    <li>
                      Grant <strong>microphone permissions</strong> when
                      prompted
                    </li>
                    <li>
                      Use a <strong>quiet environment</strong> for best results
                    </li>
                  </ul>
                </div>
              </div>
