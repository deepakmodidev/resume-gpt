                ...
                <div className="space-y-6 flex flex-col justify-center">
                    <div>
                        ...
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            Practice with an AI recruiter that speaks, listens, and adapts to your specific job role. Prepare for behavioral and technical questions in a realistic voice environment.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 p-4 bg-card rounded-xl border shadow-xs">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Tailored questions based on your resume</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 p-4 bg-card rounded-xl border shadow-xs">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Speak naturally, no typing required</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <Card className="border-2 shadow-2xl relative overflow-hidden backdrop-blur-xs bg-card/95">
                    ...
                    <CardContent className="space-y-6 pt-4">
                                            ...
                                            {isUploadingFile ? (
                                                ...
                                                <>
                                                    ...
                                                    <div className="text-left flex-1 min-w-0">
                                                        ...
                                                        <p className="text-[10px] text-green-600 dark:text-green-400 font-medium">Ready for interview</p>
                                                    </div>
                                                ...
                                                <>
                                                    ...
                                                    <div className="text-left">
                                                        ...
                                                        <p className="text-[10px] text-muted-foreground">PDF, TXT, RTF</p>
                                                    </div>
                                                </>
                                            )}
                                        </label>
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="jd" className="block mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
