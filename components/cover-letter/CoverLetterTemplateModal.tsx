                ...
                <div className="p-6 overflow-x-auto">
                    <div className="flex gap-6 pb-4">
                        {templates.map((template, index) => (
                            <div
                                key={template.id}
                                className={`shrink-0 border rounded-lg p-4 cursor-pointer hover:border-primary hover:shadow-lg transition-all duration-200 bg-card relative ${currentTemplate === template.id
                            ...
                            >
                                <div className="absolute top-2 left-2 z-10">
                                    <span
                                        className={`inline-flex items-center justify-center w-6 h-6 rounded-full text-sm font-semibold ${currentTemplate === template.id
                                ...
                                />
                                <p
                                    className={`text-center font-medium w-64 ${currentTemplate === template.id
